...
public class IntroLabTest {
     ...
     */
    @Test(timeout = 100)
    public void testGlowack8() {
        String expected = "Howdy! My name is Helena Glowacki! " +
                "I like cats more than dogs! Cats are better than people";
        String actual = IntroLab.glowack8();
        assertEquals(expected, actual);
    }
}
